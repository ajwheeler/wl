...
The Kormendy relation essentially a projection of the fundamental plane.
It states that $R_e \propto <I>^{0.83}.  We take as a prior a distribution
that is normally distributed around the line in $\log I$ - $\log R$
space defined by the Kormendy relation.

\subsection{
\end{document}

%%  LocalWords:  lensing galsim parameterized LocalWords De rsic
%%  LocalWords:  Vaucouleurs Kormendy
